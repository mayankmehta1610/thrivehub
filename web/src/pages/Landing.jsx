    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="relative min-h-[88vh] flex items-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-24 md:py-32 w-full">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-white/10 backdrop-blur-sm text-sm font-medium text-orange-300 mb-6 animate-fade-in border border-white/10">
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-12">
            <div>
              <p className="text-orange-500 font-semibold text-sm uppercase tracking-wider mb-2">Discover</p>
        ...
        <section className="py-20 md:py-28 bg-slate-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-end justify-between mb-10">
              <div>
                <p className="text-orange-500 font-semibold text-sm uppercase tracking-wider mb-2">Communities</p>
      ...
      {events.length > 0 && (
        <section className="py-20 md:py-28 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="mb-10">
              <p className="text-orange-500 font-semibold text-sm uppercase tracking-wider mb-2">Events</p>
              ...
              {events.map((e) => (
                ...
                >
                  <div className="h-44 relative">
                    ...
                    <div className="absolute top-3 left-3 px-2.5 py-1 rounded bg-slate-900/90 text-white text-xs font-semibold">
        ...
        <section className="py-20 md:py-28 bg-slate-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-12">
              <p className="text-orange-500 font-semibold text-sm uppercase tracking-wider mb-2">Stories</p>
            ...
            <div className="flex flex-wrap justify-center gap-6">
              {sponsors.map((s) => (
                <a
                  ...
                  className="block w-64 rounded-lg overflow-hidden card-hover opacity-90 hover:opacity-100 border border-slate-700"
                >
                  <SafeImage src={s.image_url} alt={s.sponsor_name} className="w-full h-32 object-cover" />
                  <div className="bg-slate-800 px-4 py-2.5 text-white text-sm font-medium text-center">
                    {s.sponsor_name}
                  </div>
                </a>
              ))}
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            <p className="text-orange-500 font-semibold text-sm uppercase tracking-wider mb-2">Platform</p>
            ...
            {features.map((f, i) => {
              ...
              return (
                <div key={f.code} className="p-6 rounded-lg border border-slate-200 bg-slate-50 card-hover">
                  <div className="w-11 h-11 rounded-md bg-slate-900 flex items-center justify-center mb-4">
